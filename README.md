...
## Skills
- **Testing**: Manual Testing, API Testing, Mobile Testing, Exploratory Testing
- **Automation**: Selenium WebDriver, Appium, RestAssured, Postman
- **Languages**: Java, JavaScript, Python
- **Tools**: Jira, Git, Jenkins, Postman, Chrome DevTools
...
## Contact
- LinkedIn: [linkedin.com/in/devarathrajan](https://linkedin.com/in/devarathrajan)
- Email: devarath2@gmail.com
- Location: Abu Dhabi, UAE
- Open for freelance QA projects
